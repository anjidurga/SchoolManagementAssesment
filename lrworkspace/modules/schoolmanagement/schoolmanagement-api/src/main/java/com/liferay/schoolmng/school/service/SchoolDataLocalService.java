...
/**
 * Provides the local service interface for SchoolData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Anjaneya
 * @see SchoolDataLocalServiceUtil
...
public interface SchoolDataLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SchoolDataLocalServiceUtil} to access the school data local service. Add custom service methods to {@link com.liferay.schoolmng.school.service.impl.SchoolDataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
